    ...
    public class ProductController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            var list = from p in db.Products
                       join c in db.Categorys on p.CateID equals c.ID
                       join parent in db.Categorys on c.ParentID equals parent.ID into parentJoin
                       from parentCategory in parentJoin.DefaultIfEmpty()
                       where p.Status != 0
                       ...
                       select new ProductCategory()
                       {
                           ...
                           CategoryName = c.Name,
                           ParentCategoryName = parentCategory.Name // Thêm tên danh mục cha
                       };
        ...
        public ActionResult Create()
        {
            ...
            var categories = db.Categorys.ToList(); // Lấy danh sách tất cả danh mục từ database
            ...
            ViewBag.ListCat = parentCategories;
        ...
        public ActionResult Create(MProduct mProduct)
        {
            ViewBag.ListCat = new SelectList(db.Categorys.Where(m => m.Status != 0), "ID", "Name", 0);
                ...
                mProduct.Specification = "laptop";
                mProduct.MetaKey = "laptop";
                mProduct.MetaDesc = "laptop";
                mProduct.Discount = 2;
